...
const TranslationContext = require$$0.createContext(null);
const TranslationProvider = ({ translations, locale, reloadKey, children }) => {
    const [language, setLanguage] = require$$0.useState(locale);
    const [lastReloadKey, setLastReloadKey] = require$$0.useState(reloadKey);
    const [lastLocale, setLastLocale] = require$$0.useState(locale);
    require$$0.useEffect(() => {
    ...
    return (jsxRuntime.jsx(TranslationContext.Provider, { value: { translations, language, changeLanguage }, children: children }));
};
...
function requireLib$6 () {
	...
	(function (exports$1) {
		...
		var __exportStar = (lib$5 && lib$5.__exportStar) || function(m, exports$1) {
...
function requireLib$3 () {
	...
	(function (exports$1) {
		...
		var __exportStar = (lib$3 && lib$3.__exportStar) || function(m, exports$1) {
		    for (var p in m) if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports$1, p)) __createBinding(exports$1, m, p);
		};
		Object.defineProperty(exports$1, "__esModule", { value: true });
...
function requireCommonjs () {
	...
	(function (exports$1) {
		 ...
		 */
		exports$1.ElementType = __importStar(/*@__PURE__*/ requireLib$7());
		...
		exports$1.DomUtils = __importStar(/*@__PURE__*/ requireLib$3());
...
function requireLib$2 () {
	...
	(function (exports$1) {
		...
		var __exportStar = (lib$6 && lib$6.__exportStar) || function(m, exports$1) {
		    for (var p in m) if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports$1, p)) __createBinding(exports$1, m, p);
		};
...
const interpolateVariables = (text, variables = {}, parseHtml = true) => {
...
const useTranslation = () => {
    const context = require$$0.useContext(TranslationContext);
    if (!context) {
        throw new Error('useTranslation must be used within a TranslationProvider');
    }
    const { translations, language } = context;
    return {
        t: (key, variables, parseHtml = true) => {
